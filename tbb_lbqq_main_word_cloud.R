...
docs <- tm_map(docs, content_transformer(function(x, pattern) gsub(x, pattern = "económica", replacement = "economía")))
docs <- tm_map(docs, content_transformer(function(x, pattern) gsub(x, pattern = "económicas", replacement = "economía")))
docs <- tm_map(docs, content_transformer(function(x, pattern) gsub(x, pattern = "económico", replacement = "economía")))
docs <- tm_map(docs, content_transformer(function(x, pattern) gsub(x, pattern = "economías", replacement = "economía")))
docs <- tm_map(docs, content_transformer(function(x, pattern) gsub(x, pattern = "sociales", replacement = "social")))
...
docs <- tm_map(docs, removeWords, c("hacia")) 
